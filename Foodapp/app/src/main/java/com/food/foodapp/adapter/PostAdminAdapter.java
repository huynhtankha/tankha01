...
public class PostAdminAdapter extends RecyclerView.Adapter<PostAdminAdapter.MyViewHolder>{
    ...
    public PostAdminAdapter(Context context, List<Posts> array) {
    ...
    @NonNull
    @Override
    public PostAdminAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adminpost,parent,false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PostAdminAdapter.MyViewHolder holder, int position) {
